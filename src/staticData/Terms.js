export default function Terms() {
  return (
    <div>
      ...
      <p>Welcome to THE REBEL GROOMING!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of THE REBEL GROOMING CO's Website, located at
        https://therebelgrooming.com/.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use THE REBEL GROOMING if you do not
      ...
      <p>
        We employ the use of cookies. By accessing THE REBEL GROOMING, you
        agreed to use cookies in agreement with the THE REBEL GROOMING CO's
        Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, THE REBEL GROOMING CO and/or its licensors own
        the intellectual property rights for all material on THE REBEL GROOMING.
        All intellectual property rights are reserved. You may access this from
        THE REBEL GROOMING for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from THE REBEL GROOMING</li>
        <li>Sell, rent or sub-license material from THE REBEL GROOMING</li>
        <li>Reproduce, duplicate or copy material from THE REBEL GROOMING</li>
        <li>Redistribute content from THE REBEL GROOMING</li>
      </ul>
      <p>
      ...
      <p>
        ...
        REBEL GROOMING CO does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of THE REBEL GROOMING CO,its agents and/or
        ...
        laws, THE REBEL GROOMING CO shall not be liable for the Comments or for
      ...
      <p>
        THE REBEL GROOMING CO reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant THE REBEL GROOMING CO a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of THE REBEL GROOMING CO; and (d)
      ...
      <p>
        ...
        e-mail to THE REBEL GROOMING CO. Please include your name, your
      ...
      <p>
        No use of THE REBEL GROOMING CO's logo or other artwork will be allowed
