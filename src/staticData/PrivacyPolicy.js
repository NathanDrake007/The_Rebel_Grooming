export default function PrivacyPolicy() {
  return (
    <div>
      <h1>Privacy Policy for THE REBEL GROOMING CO</h1>
      <p>
        At THE REBEL GROOMING, accessible from https://therebelgrooming.com/,
        one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by THE REBEL GROOMING and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in THE REBEL GROOMING. This policy is not
      ...
      <h2>Log Files</h2>
      <p>
        THE REBEL GROOMING follows a standard procedure of using log files.
      ...
      <p>
        ...
        advertising partners of THE REBEL GROOMING.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on THE REBEL GROOMING, which are
      ...
      <p>
        Note that THE REBEL GROOMING has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        THE REBEL GROOMING's Privacy Policy does not apply to other advertisers
      ...
      <p>
        THE REBEL GROOMING does not knowingly collect any Personal Identifiable
